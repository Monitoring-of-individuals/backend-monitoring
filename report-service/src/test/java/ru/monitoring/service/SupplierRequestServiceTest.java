...
class SupplierRequestServiceTest {
    ...
    void getApiCloudBalance() {
        ...
        when(apiCloudClient.getApiCloudResponse("/apilk.php", paramMap)).thenReturn(balanceJson);
    ...
    void getApiCloudBalanceAndReturnNull() {
        ...
        when(apiCloudClient.getApiCloudResponse("/apilk.php", paramMap)).thenReturn(null);

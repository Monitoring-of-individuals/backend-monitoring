...
public final class ReportBuilder {
    ...
    public ReportBuilder addFsspResponse(FsspResponse fsspResponse) {
        this.fsspResponse = checkingIfStatusNot200(fsspResponse) ? FsspMapper.toResponseDto(fsspResponse) : null;
        return this;
    }

    public ReportBuilder addInnResponse(InnResponse innResponse) {
        this.innResponse = checkingIfStatusNot200(innResponse) ? InnMapper.toResponseDto(innResponse) : null;
        return this;
    }
    ...
    public ReportBuilder addGibddResponse(GibddResponse gibddResponse) {
        this.gibddResponse = checkingIfStatusNot200(gibddResponse) ? GibddMapper.toResponseDto(gibddResponse) : null;
        return this;
    }
    ...
    public ReportBuilder addBankruptResponse(BankruptResponse bankruptResponse) {
        this.bankruptResponse = checkingIfStatusNot200(bankruptResponse) ? BankruptMapper.toResponseDto(bankruptResponse) : null;
        return this;
    }
